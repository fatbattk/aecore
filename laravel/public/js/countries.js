...
function print_country(country_id, state_id, default_country, default_state){
  ...
  if(default_country != "") {
    $("#"+country_id).val(default_country);
    print_state(state_id, country_arr.indexOf(default_country));
    if(default_state != "") {
